...
clustered_plate_data AS (
    SELECT
        ...
        CASE
            WHEN plate_name IN ('医疗设备及用品', '医疗及医学美容服务', '医药外包概念', '医疗保健', '中医药', '中医药概念', '药品', '药品分销', '生物技术', '生物医药', '生物医药B类股', '创新药概念', 'AI医疗概念股', '互联网医疗', '医美概念股', '养老概念') THEN '医疗与健康'
            WHEN plate_name IN ('地产投资', '地产发展商', '楼宇建造', '内房股', '内地物业管理股', '物业服务及管理', '建筑材料', '建材水泥股', '地产代理', '房地产基金', '房地产投资信托') THEN '地产与建筑'
