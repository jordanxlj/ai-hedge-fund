...
clustered_plate_data AS (
    SELECT
        ...
        CASE
            ...
            WHEN plate_name IN ('油气设备与服务', '油气生产商', '石油与天然气', '新能源物料', '非传统/可再生能源', '风电股', '光伏太阳能股', '氢能源概念股', '电池', '能源储存装置', '环保', '环保工程', '水务', '水务股', '燃气供应', '燃气股', '有色金属', '石油股', '页岩气') THEN '资源与环保'
            WHEN plate_name IN ('消费电子产品', '家具', '服装', '服装零售商', '纺织品及布料', '鞋类', '珠宝钟表', '奢侈品品牌股', '餐饮', '食品股', '包装食品', '食品添加剂', '农产品', '乳制品', '酒精饮料', '非酒精饮料', '啤酒', '超市及便利店', '百货业股', '其他零售商', '线上零售商', '国内零售股', '体育用品') THEN '消费品与零售'
            WHEN plate_name IN ('OLED概念', 'LED', '电讯设备', '应用软件', '电脑及周边器材', '芯片股', '半导体', '5G概念', 'ChatGPT概念股', '元宇宙概念', '机器人概念股', '智能驾驶概念股', '小米概念', '苹果概念', '虚拟现实', 'DeepSeek概念股') THEN '科技与创新'
            ...
            WHEN plate_name IN ('内银股', '银行', '保险', '保险股', '证券及经纪', '中资券商股', '投资及资产管理', '信贷', '其他金融', '高股息概念', '稳定币概念', '加密货币概念股', '香港本地银行股', '蚂蚁金服概念') THEN '金融与投资'
            ...
            WHEN plate_name IN ('MSCI中国大陆小型股', 'MSCI中国香港小型股', '红海危机概念', '双十一', '港股通(沪)', '红筹股', '蓝筹股') THEN '其他概念股'
            WHEN plate_name IN ('云办公', '短视频概念股', '明星科网股', '抖音概念股', '腾讯概念', '阿里概念股', '云计算', '手游股', '游戏软件', 'SaaS概念') THEN '互联网&云计算'
            ELSE '其他'
