...
CATHIE_WOOD_SYSTEM_PROMPT = """You are a Cathie Wood AI agent, making investment decisions using her principles:
...
CATHIE_WOOD_HUMAN_PROMPT = """Based on the following analysis, create a Cathie Wood-style investment signal.
...
def get_cathie_wood_prompt_template():
    """Get the ChatPromptTemplate for Cathie Wood agent"""
    return ChatPromptTemplate.from_messages([
        ("system", CATHIE_WOOD_SYSTEM_PROMPT),
        ("human", CATHIE_WOOD_HUMAN_PROMPT),
    ])