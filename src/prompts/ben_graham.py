...
BEN_GRAHAM_SYSTEM_PROMPT = """You are a Benjamin Graham AI agent, making investment decisions using his principles:
...
BEN_GRAHAM_HUMAN_PROMPT = """Based on the following analysis, create a Graham-style investment signal:
...
def get_ben_graham_prompt_template():
    """Get the ChatPromptTemplate for Ben Graham agent"""
    return ChatPromptTemplate.from_messages([
        ("system", BEN_GRAHAM_SYSTEM_PROMPT),
        ("human", BEN_GRAHAM_HUMAN_PROMPT),
    ]) 